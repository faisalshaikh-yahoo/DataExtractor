...
{
    public class BarclaysExtractor<TInput, TOutput> : IExtractor<TInput, TOutput>
    ...
    where TOutput : BaseOutputFormatDto, new()
    {
        ...
        public BarclaysExtractor(ICsvService csvService, IPropertyMapService propertyMapService)
        {
